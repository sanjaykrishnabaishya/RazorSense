    ...
    <div className="relative w-full max-w-[400px] h-[300px] flex items-center justify-center">
      <div className="relative w-full h-full flex items-center justify-center -mr-16 mt-8">
        ...
        <motion.div 
          ...
          className="absolute top-0 -left-10 bg-[#111]/80 backdrop-blur-md border border-white/10 rounded-2xl rounded-br-sm px-5 py-4 shadow-[0_0_30px_rgba(0,0,0,0.8)] z-50 w-[240px]"
        >
