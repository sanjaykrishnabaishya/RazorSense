...
export default function IssueSelector({ selectedIssue, setSelectedIssue, setStage, setMessages }: any) {
  ...
  const issues = [
    { id: 'refund', label: 'Refund', desc: 'I want a refund', icon: RefreshCcw, color: 'text-mint-dark', bgHover: 'hover:bg-mint-soft' },
    { id: 'replacement', label: 'Replacement', desc: 'I want a replacement', icon: Package, color: 'text-violet-main', bgHover: 'hover:bg-[var(--violet-soft)]' },
    ...
    { id: 'product-issue', label: 'Product issue', desc: 'Damaged / faulty', icon: TriangleAlert, color: 'text-warning', bgHover: 'hover:bg-[var(--warning-soft)]' },
    ...
    { id: 'other', label: 'Other', desc: 'Something else', icon: Ellipsis, color: 'text-primary', bgHover: 'hover:bg-primary-soft' }
  ];
  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="flex items-center gap-4">
        <div className="w-14 h-14 rounded-2xl bg-primary-soft flex items-center justify-center text-primary">
          <FileText size={24} />
        </div>
        <div>
      ...
      <div className="flex items-center gap-4 mt-6">
        <button 
          ...
          className="bg-gradient-to-b from-[var(--color-primary)] to-[var(--primary-dark)] text-white px-8 py-3.5 rounded-lg font-semibold text-[15px] flex items-center justify-center gap-2 transition hover:shadow-md"
        >
